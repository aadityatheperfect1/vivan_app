...
class _VoicechatscreenState extends State<Voicechatscreen> {
  ...
  Future<void> _processAndSendRecording() async {
    ...
    try {
      final payload = {
        "type": "voiceRequest",
        "vehicle": usbManager.connectedVehicle?['vehicle'],
  ...
  Widget build(BuildContext context) {
    ...
    print("Device: ${usbManager.connectedDevice}");
    print("Vehicle: ${usbManager.connectedVehicle}");
    ...
    // if (usbManager.connectedVehicle?['vehicle'] == null) {
